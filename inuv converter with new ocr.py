...
base_folders = {
    "направления": "новый совместный датасет/направления",
    "доп_данные": "новый совместный датасет/доп хуйня если есть",
    "макет": "новый совместный датасет/шаблоны"
}

json_path = "new_train.json"
...
for section, folder_path in base_folders.items():
    ...
    for file_name in os.listdir(folder_path):
        ...
        if code not in docs_by_code:
            docs_by_code[code] = {"код": code, "направления": "", "доп_данные": "", "макет": ""}
